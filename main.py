...
def attack(char_name: str, char_class: str) -> str:
    """Функция возвращает значение нанесенного противнику урона."""
...
def defence(char_name: str, char_class: str) -> str:
    """Функция возвращает значение заблокированного урона противника."""
    if char_class == 'warrior':
...
def special(char_name: str, char_class: str) -> str:
    """Функция возвращает значение специального умения персонажа."""
    if char_class == 'warrior':
...
def start_training(char_name: str, char_class: str) -> str:
    """Функция проверяет класс персонажа.
    Так же она принимает одну из команд для его тренировки.
    """
    if char_class == 'warrior':
...
def choice_char_class() -> str:
    ...
    Затем выводится на экран описание его качеств.
    """
    approve_choice: str = ''
    char_class: str = ''
...
if __name__ == '__main__':
    """Функция запкускает основную прогрумму и её."""
    run_screensaver()
